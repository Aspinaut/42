...
/*   Updated: 2021/11/07 12:52:45 by vmasse           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// printf("moveplayer\n");
	if (game->player.dir == UP && check_next_tile(game, UP))
	{
		game->player.sprite->y--;

	}
	else if (game->player.dir == DOWN && check_next_tile(game, DOWN))
	{
		game->player.sprite->y++;

	}
	else if (game->player.dir == LEFT && check_next_tile(game, LEFT))
	{
		game->player.sprite->x--;

	}
	else if (game->player.dir == RIGHT && check_next_tile(game, RIGHT))
	{
		game->player.sprite->x++;
